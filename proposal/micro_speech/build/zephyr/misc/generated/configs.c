...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SRAM_OFFSET, 0x2400);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_XTENSA_TIMER_ID, 0);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CPU_HAS_MMU, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_XTENSA_DC233C, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_KERNEL_VM_OFFSET, 0x100000);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_CDNS_TENSILICA_XTENSA_LX3_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_QEMU_XTENSA, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_QEMU_XTENSA_DC233C, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SIMULATOR_XTENSA, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_XTENSA_GEN_HANDLERS, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_XTENSA_SIM_CONSOLE, 1);
